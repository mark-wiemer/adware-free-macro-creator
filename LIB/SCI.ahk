...
__sendEditor(hwnd, msg:=0, wParam:=0, lParam:=0){
    ...
    ,SCI_GETPROPERTY:=4008,SCI_GETPROPERTYEXPANDED:=4009,SCI_GETPROPERTYINT:=4010,SCI_GETSTYLEBITSNEEDED:=4011, SCI_SETEXTRAASCENT:=2525
    ,SCI_SETINDICATORCURRENT:=2500,SCI_INDICATORCLEARRANGE:=2505,SCI_INDICSETOUTLINEALPHA:=2558,SCI_INDICSETALPHA:=2523,SCI_INDICATORFILLRANGE:=2504
    ,SCI_INDICATORSTART:=2508,SCI_INDICATOREND:=2509,SCI_INDICATORALLONFOR:=2506,SCI_AUTOCSETORDER:=2660,SCI_SETCARETLINEVISIBLEALWAYS:=2655
